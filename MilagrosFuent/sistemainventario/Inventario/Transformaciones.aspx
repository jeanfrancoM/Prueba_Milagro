<%@ Page Title="Nota de Ingreso - Salida" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"   CodeBehind="Transformaciones.aspx.cs" Inherits="SistemaInventario.Inventario.Transformaciones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Transformaciones.js" charset="UTF-8"></script>
  ...
  <td style="font-weight: bold;">
   ...
   <td >
                        ...
                        <tr>
                            ...
                            <td >
                                <asp:TextBox ID="txtObservacion" runat="server" Width="457px" 
                                    Font-Names="Arial" ForeColor="Blue" Font-Bold="True" ReadOnly="False"></asp:TextBox>
                            </td>
                            <td style="font-weight: bold;">
                                Responsable
                            </td>
                            <td >
                                <asp:TextBox ID="txtResponsable" runat="server" Width="380px"
                                    Font-Names="Arial" ForeColor="Blue" Font-Bold="True" ReadOnly="False"></asp:TextBox>
                            </td>
                ...
                <div class="linea-button">                  
                                ...
                                <asp:CheckBox ID="chkImprimirGuia" style="display: none" runat="server" Text="Imprimir" Checked="True" />
            ...
            <div id="div_consulta" style="padding-top: 5px;">
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Partida" HeaderText="Salida">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Destino" HeaderText="Entrada">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:BoundField>
        ...
        <div id="div_grvConsultaArticulo" style="padding-top: 5px;">
            <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Aliviano">
                        <ItemStyle HorizontalAlign="Right" />
                        <ItemTemplate>
                            <asp:Label runat="server" ID="lbl4Piso" Text='<%# Bind("Aliviano") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Acontenedores">
                        <ItemStyle HorizontalAlign="Right" />
                        <ItemTemplate>
