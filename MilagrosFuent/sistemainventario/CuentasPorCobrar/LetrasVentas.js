...
$(document).ready(function () {
    ...
    $('#MainContent_btnAgregarFactura').click(function () {
        ...
        try {
            ...
            var objParams = {
                ...
                Filtro_CodMoneda: 2, //$('#MainContent_ddlMoneda').val(),
    ...
    $('#MainContent_btnValidar2').click(function () {
        if (!F_SesionRedireccionar(AppSession)) return false;
    ...
    $('#MainContent_txtNroLetra').blur(function () {
        if ($('#MainContent_txtNroLetra').val() == '')
            return false;
        var id = '00000000' + $('#MainContent_txtNroLetra').val();
        $('#MainContent_txtNroLetra').val(id.substr(id.length - 8));
        return false;
    });
...
try 
        ...
        $('#MainContent_grvConsultaFactura .chkSi :checkbox').each(function () {
            ...
            if ($(chkSi).is(':checked')) {
                ...
                $('#hfCodMoneda').val($(hfCodMoneda).val());
            }
        });
  ...
  try 
        ...
        $('#MainContent_grvLetra .chkDelete :checkbox').each(function () {
                ...
                var objParams = {
                    ...
                    Filtro_CodMoneda:  2, //$(Contenedor + 'ddlMoneda').val(),
                    Filtro_XmlDetalle: Sys.Serialization.JavaScriptSerializer.serialize(arrDetalle)
                };
