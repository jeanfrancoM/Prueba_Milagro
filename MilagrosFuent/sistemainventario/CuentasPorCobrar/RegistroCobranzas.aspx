...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="font-weight: bold; padding-left: 56px">
                                            Fecha
                                        </td>
                                        <td>
            ...
            <div style="padding-top: 5px;">
                <table cellpadding="0" cellspacing="0">
                    <tr>
                        <td valign="top">
                            <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
                                PROFORMAS | NOTAS DE CREDITO POR COBRAR
                            </div>
                            <div>
                                <table width="1205px">
                                    <tr align="right">
                            ...
                            <div id="div_grvFacturaCobranzas" style="padding-top: 1px;">
                                <asp:GridView ID="grvFacturaCobranzas" runat="server" AutoGenerateColumns="False"
                                    ...
                                    Width="1205px" OnRowDataBound="grvFacturaCobranzas_RowDataBound">
                                    <Columns>
                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:CheckBox ID="chkRango" runat="server" Text="OPERACION" Font-Bold="True" />
                                            </td>
                                            <td>
            ...
            <div id="div_consulta" style="padding-top: 5PX;">
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="NroRecibo" HeaderText="Recibo" DataFormatString="{0:N2}" Visible="false" >
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:BoundField>
    ...
    <input id="hfCodCtaCteConsulta" type="hidden" value="0" />
     <input id="hfCodCtaCteConsultaEliminado" type="hidden" value="0" />
