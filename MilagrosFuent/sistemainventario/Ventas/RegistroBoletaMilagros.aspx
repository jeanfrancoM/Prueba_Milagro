<%@ Page Title="Boleta" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroBoletaMilagros.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroBoletaMilagros" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroBoletaMilagros.js"
                                        ...
                                        <td style="padding-left: 8px;">
                                            <div id="div_formapago">
                                                <asp:DropDownList ID="ddlFormaPago" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                    Font-Bold="True" Width="92" Enabled="True">
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                                        <td style="font-weight: bold">
                                        ...
                                        <td>
                                            <div id="div_VendedorComision">
                                                <asp:DropDownList ID="ddlVendedorComision" runat="server" Font-Names="Arial" ForeColor="Blue"
                                                    Font-Bold="True" BackColor="#FFFF99" Width="100">
                                                </asp:DropDownList>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         <td>
                                            <asp:CheckBox ID="chkSi" runat="server" Text="SI" Font-Bold="True"
                                                onclick="F_ValidarCheckMayoristaSINO(this.id);" ForeColor="Red"  />
                                        </td>
                                        <td>
                                            <asp:CheckBox ID="chkNo" runat="server" Text="NO" Font-Bold="True"
                                                onclick="F_ValidarCheckMayoristaSINO(this.id);" ForeColor="Red"  />
                                        </td>
                                        <td>
                ...
                <div class="linea-button">
                  <asp:Button ID="btnNuevo" runat="server" Text="Limpiar" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                    ...
                    <asp:Button ID="btnFacturarCT" runat="server" Text="Cotizacion" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                        Font-Names="Arial" Font-Bold="True" Width="120" />
                    <asp:Button ID="btnFacturarNV" runat="server" Text="Proforma" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                        Font-Names="Arial" Font-Bold="True" Width="120" />
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgAnularDocumento" ImageUrl="~/Asset/images/Eliminar.jpg"
                                    ToolTip="ANULAR BOLETA" OnClientClick="F_AnularRegistro(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
    ...
    <div id="divConsultaArticulo" style="display: none;">
        ...
        <div id="div_grvConsultaArticulo" style="padding-top: 5px;">
            <asp:GridView ID="grvConsultaArticulo" runat="server" AutoGenerateColumns="False"
                border="0" CellPadding="0" CellSpacing="1" CssClass="GridView" GridLines="None"
                Width="1180px" OnRowDataBound="grvConsultaArticulo_RowDataBound">
                <Columns>
                    <asp:TemplateField HeaderText="" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Descripcion">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hfPrecioMayoristaDolares" runat="server" Value='<%# Bind("PrecioMayoristaDolares") %>' />
                            <asp:HiddenField ID="hfPrecioMayoristaSoles" runat="server" Value='<%# Bind("PrecioMayoristaSoles") %>' />
...
<%--                    <asp:TemplateField HeaderText="Stock">
                    ...
                    <asp:TemplateField HeaderText="Costo" Visible="true">
                        <ItemStyle HorizontalAlign="Center" />
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Mayorista">
                        <ItemStyle HorizontalAlign="Center" />
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Minorista" Visible="false">
                        <ItemStyle HorizontalAlign="Center" />
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="IGV" ItemStyle-HorizontalAlign="Center" Visible="false">
                        <ItemTemplate>
                            ...
                            <%--<asp:CheckBox runat="server" ID="CheckBox1" CssClass="chkSi" Text="" onclick="F_ValidarCheck(this.id);" />--%>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Cant." ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txtCantidad" Width="55px" Font-Bold="true" Style="text-align: center;"
                                ForeColor="Blue" Font-Names="Arial" onblur="F_ValidarStockGrilla(this.id);" CssClass="ccsestilo"
                                Enabled="False"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
        ...
        <div id="div_grvConCTVenta" style="padding-top: 5px;">
            <asp:GridView ID="grvConCTVenta" runat="server" AutoGenerateColumns="False" border="0"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="Serie">
                        <ItemTemplate>
                            <asp:Label ID="lblNvSerie" runat="server" Text='<%# Bind("Serie") %>'></asp:Label>
