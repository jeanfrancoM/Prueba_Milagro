                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td >
                                            <asp:TextBox ID="txtCelularCliente" runat="server" Width="100px" Font-Names="Arial" ForeColor="Blue"
                                                Font-Bold="True" ></asp:TextBox>
                                        </td>
                          ...
                          <asp:TemplateField Visible="true">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgAprobar" ImageUrl="~/Asset/images/ok.gif"
                                    ToolTip="Aprobar Documento" OnClientClick="F_AprobarCotizacion(this); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField Visible="true">
                            <ItemTemplate>
