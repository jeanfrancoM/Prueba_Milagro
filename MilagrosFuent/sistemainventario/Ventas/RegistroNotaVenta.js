...
function F_AgregarTemporal(controlId) {
    ...
    if ($(chkSi).is(':checked')) {
        ...
        var html = '<tr>';
            ...
            html += '<input type="hidden" name="ctl00$MainContent$grvDetalleArticulo$ctl24$hfcodarticulo" id="MainContent_grvDetalleArticulo_hfcodarticulo_' + c + '" value="' + $(lblcodproducto_grilla).text() + '">';
            ...
            html += '<input type="hidden" name="ctl00$MainContent$grvDetalleArticulo$ctl24$hfDescripcion" id="MainContent_grvDetalleArticulo_hfDescripcion_' + c + '" value="' + $(lblProducto).text().replace("&", "&amp;") + '">';
            ...
            html += '</td><td align="left" class="csimp" id="MainContent_grvDetalleArticulo_lblCodigoProducto_' + c + '" >' + $(hlkCodigo).text() + '</td><td align="center">';
...
//        html += '<td align="left">' + $(hlkCodigo).text() + '</td>';
//        html += '<td align="center">';
//        html += '<input name="ctl00$MainContent$grvDetalleArticulo$ctl02$txtDescripcion" type="text" value="' + $(lblProducto).text() + '" id="MainContent_grvDetalleArticulo_txtDescripcion_' + c + '" class="ccsestilo" onchange="F_ActualizarDescripcionNP(this.id); return false;"  style="color: blue; font-family: Arial; font-weight: bold; width: 480px; background: rgb(255, 255, 224);">';
//        html += '</td>';
//        html += '<td align="center">';
...
//        recalcularmontos();
//        numerar();
//        toastr.warning("Se agrego correctamente.");
//    }
}
