...
function F_Buscar(){
    ...
    if (Number($('#hfCodCtaCte').val()) > 0 & $("#MainContent_ddlEmpresa").val() != 0) {
        alertify.log('CUANDO SE ESPECIFICA CLIENTE, SE CONSULTA PARA TODAS LAS EMPRESAS');
    ...
    rptURL = rptURL + 'CodRuta='        + $("#MainContent_ddlRuta").val() + '&';
