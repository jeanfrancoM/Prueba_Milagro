...
function F_Buscar() {
    ...
    rptURL = rptURL + 'Vendedor=' + $("#MainContent_ddlVendedorComision option:selected").text() + '&';
    rptURL = rptURL + 'VentaExterna=' + (($("#MainContent_chkVenasExternas").is(':checked')) ? '1' : '0') + '&';
    rptURL = rptURL + 'CodVendedor=' + $("#MainContent_ddlVendedorComision").val() + '&';
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_VendedorComision', result.split('~')[5]);              
                        ...
                        $('#MainContent_ddlVendedorComision').val(0);
