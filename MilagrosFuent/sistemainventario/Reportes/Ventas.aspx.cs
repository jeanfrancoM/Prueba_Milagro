    ...
    public partial class Ventas : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlEmpresa, ref ddlTipoDoc, ref ddlSucursal, ref ddlVendedorComision);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_comboempresa, ref DropDownList ddl_combotipodoc, ref DropDownList ddl_combosucursal, ref DropDownList ddl_combovendedorcomision)
        {
            ...
            ddl_combovendedorcomision.Items.Insert(0, new ListItem("TODOS", "0"));
        }   
    }
}