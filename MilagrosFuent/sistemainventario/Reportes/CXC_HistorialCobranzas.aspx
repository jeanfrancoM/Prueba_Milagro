<%@ Page Title="Reporte Historial Cobranzas" Language="C#" MasterPageFile="~/Site.Master"  AutoEventWireup="true" CodeBehind="CXC_HistorialCobranzas.aspx.cs" Inherits="SistemaInventario.Reportes.CXC_HistorialCobranzas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="CXC_HistorialCobranzas.js"  charset="UTF-8"></script>     
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 500px">
        Reporte Historial Cobranzas</div>
                    ...
                    <td colspan='4' style="padding-left: 4px;">
                        <div id="div1">
                            <asp:DropDownList ID="ddlTipoDocumento" runat="server" Font-Names="Arial" ForeColor="Blue"
                                Font-Bold="True" Width="344" BackColor="#FFFF99">
                    ...
                    <td colspan='4'>
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td>
                                    <asp:CheckBox ID="chkDetallado" runat="server" Text="Detallado" Font-Bold="True" Checked="True" Enabled="False" />
                                </td>
                            </tr>
                        </table>
                    </td>
