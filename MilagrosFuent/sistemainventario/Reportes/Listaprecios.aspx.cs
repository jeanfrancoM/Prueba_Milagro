    ...
    public partial class Listaprecios : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros,  ref ddlExcel);

                str_ddl_Excel_html = Mod_Utilitario.F_GetHtmlForControl(ddlExcel);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList comboempresa)
        {
            ...
            dta_consulta = objOperacionEmpresa.ListarExcel();
