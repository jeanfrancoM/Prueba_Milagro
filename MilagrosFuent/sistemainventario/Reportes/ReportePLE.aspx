<%@ Page Title="Reporte PLE" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ReportePLE.aspx.cs" Inherits="SistemaInventario.Reportes.ReportePLE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ReportePLE.js" charset="UTF-8"></script>
                            ...
                            <td>
                                <div id="div1">
                                    <asp:DropDownList ID="ddlTipo" runat="server" Font-Names="Arial" ForeColor="Blue"
                                        ...
                                        <asp:ListItem Value="1" Selected>Facturas</asp:ListItem>
                                        <asp:ListItem Value="2">Proformas</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </td>
                            <td>
