...
(function($) {
    ...
    function getHead() {
        ...
        $(document).find("link")
            ...
            .each(function() {
                head += '<link type="text/css" rel="stylesheet" href="../asset/css/style.css" >';
                head += '<link href="../asset/css/redmond/ui.jqgrid.css" rel="stylesheet" type="text/css" />';
                head += '<link href="../asset/css/redmond/jquery-ui-1.8.16.custom.css" rel="stylesheet" type="text/css" />';
            });
    ...
    function getBody(printElement) {
        return '<body><h3 class="titulo">FICHA CERRAR CITA</h3>' + $(printElement).html() + '</body>';
    }
