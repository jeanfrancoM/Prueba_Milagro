...
{
    public partial class CobranzasConsultas : System.Web.UI.Page
    {
        protected override void OnInit(EventArgs e)
        {
            ...
            CallbackManager.Register(F_VERIFICARNC_NET);
        }
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (lblCodigo.Value != "")
                {
                    objEntidad.CodCobranzaCab = Convert.ToInt32(lblCodigo.Value);
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddl_destinocajaempresa_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlMoneda, ref ddlMedioPago, ref ddlBanco, ref ddlDestinoCajaEmpresa);
                ...
                str_ddl_destinocajaempresa_html = Mod_Utilitario.F_GetHtmlForControl(ddlDestinoCajaEmpresa);
            ...
            str_resultado =
                ...
                str_ddl_destinocajaempresa_html;
        ...
        public String F_Buscar_Factura_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Cargar_Grilla(obj_parametros, ref grvConsultaFactura,ref Contador);
        ...
        public String F_Buscar_NotaVenta_NET(String arg)
        {
            ...
            try
            {
                ...
                if (grvConsultaFactura.Rows.Count == 0) P_LlenarGrillaVacia_ConsultaFactura();
        ...
        public String F_EditarDetalle_NET(String arg)
        {
            ...
            try
            {
                ...
                P_ValidarCheck(obj_parametros, ref ddlBanco);
        ...
        public String F_Editar_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            String str_ddl_banco_html = "";
        ...
        public String F_VERIFICARNC_NET(String arg)
        {
            String str_resultado = "";
            String str_mensaje_operacion = "";
            Int32 CodigoNotaCredito = 0;
            Int32 CodMoneda = 0;
            decimal Saldo = 0;
            int int_resultado_operacion = 0;
            Hashtable obj_parametros = null;
            ...
            try
            {
                ...
                P_VERIFICARNC(obj_parametros, ref CodigoNotaCredito, ref Saldo, ref str_mensaje_operacion, ref CodMoneda);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_combomoneda, ref DropDownList ddl_combomediopago, ref DropDownList ddl_combobanco, ref DropDownList ddl_destinocajaempresa)
        {
            ...
            objEntidadConceptosDet.CodConcepto = 32;

            objOperacionConceptosDet = new TCConceptosDetCN();
            dta_consulta = null;
            dta_consulta = objOperacionConceptosDet.F_TCConceptos_Select(objEntidadConceptosDet);

            ddl_destinocajaempresa.Items.Clear();

            ddl_destinocajaempresa.DataSource = dta_consulta;
            ddl_destinocajaempresa.DataTextField = "DscAbvConcepto";
            ddl_destinocajaempresa.DataValueField = "CodConcepto";
            ddl_destinocajaempresa.DataBind();
        ...
        public void P_Inicializar_GrillaVacia_Factura()
        {
            ...
            dta_consultaarticulo.Columns.Add("CodMoneda2", typeof(string));
            ...
            dta_consultaarticulo.Columns.Add("FechaOperacion", typeof(string));
            dta_consultaarticulo.Columns.Add("Banco", typeof(string));
            dta_consultaarticulo.Columns.Add("NumeroCuenta", typeof(string));
            dta_consultaarticulo.Columns.Add("FlagCheck", typeof(string));
            ...
            grvFactura.DataBind();
            grvFactura.UseAccessibleHeader = true;
            grvFactura.HeaderRow.TableSection = TableRowSection.TableHeader;
        }
        ...
        public void P_Inicializar_GrillaVacia_Consulta()
        {
            ...
            dta_consulta.Columns.Add("SaldoAplicado", typeof(string));
            dta_consulta.Columns.Add("Documentos", typeof(string));
            dta_consulta.Columns.Add("FechaDescarga", typeof(string));
            dta_consulta.Columns.Add("FechaEntrada", typeof(string));
            dta_consulta.Columns.Add("Fecha", typeof(string));
            dta_consulta.Columns.Add("Usuario", typeof(string));
            dta_consulta.Columns.Add("UsuarioAuxiliar", typeof(string));
        ...
        public void P_Cargar_Grilla(Hashtable objTablaFiltro, ref GridView grvConsulta,ref int Contador)
        {
            ...
            grvConsulta.DataBind();
            Contador = grvConsulta.Rows.Count;
        }
        ...
        public void P_AgregarTemporal(Hashtable objTablaFiltro, ref Int32 Codigo, ref String MsgError)
        {
            ...
            foreach (dynamic item in jArr2)
            {
                ...
                XmlDetalle = XmlDetalle + " Vencimiento = '" + item.Vencimiento + "'";
        ...
        public void P_CargarGrillaTemporal_Factura(Hashtable objTablaFiltro, Int32 Codigo, ref GridView grvDetalle, ref Decimal TotalFactura)
        {
            ...
            grvDetalle.DataBind();
            grvDetalle.UseAccessibleHeader = true;
            grvDetalle.HeaderRow.TableSection =TableRowSection.TableHeader;
        }
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodCliente = Convert.ToInt32(objTablaFiltro["Filtro_CodCtaCte"]);
            objEntidad.CodUsuarioAuxiliar = Convert.ToInt32(objTablaFiltro["Filtro_CodUsuarioAuxiliar"]);
            objEntidad.FlagSaldoAplicado = Convert.ToInt32(objTablaFiltro["Filtro_SaldoAplicado"]);
            objEntidad.CodNotaCredito = Convert.ToInt32(objTablaFiltro["Filtro_CodNotaCredito"]);
            objEntidad.CodDestinoCajaEmpresa = Convert.ToInt32(objTablaFiltro["Filtro_CodDestinoCajaEmpresa"]);

            objOperacion = new DocumentoVentaCabCN();

            if (Convert.ToInt32(objTablaFiltro["Filtro_CodTipoDoc"])==1)
                objOperacion.F_Cobranzas_RegistroCobranzas(objEntidad);
            else
                objOperacion.F_Cobranzas_RegistroCobranzas_Letras(objEntidad);
            MsgError = objEntidad.MsgError;
        }
        ...
        public void P_ActualizarTC(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.CodCtaBancaria = Convert.ToInt32(objTablaFiltro["Filtro_CodCtaBancaria"]);
            objEntidad.NroOperacion = Convert.ToString(objTablaFiltro["Filtro_NroOperacion"]);
            objEntidad.FechaOperacion = Convert.ToString(objTablaFiltro["Filtro_FechaOperacion"]);
            objEntidad.FlagCheck = Convert.ToInt32(objTablaFiltro["Filtro_FlagCheck"]);
            objEntidad.Observacion = Convert.ToString(objTablaFiltro["Filtro_Observacion"]);
            objEntidad.Saldo = Convert.ToDecimal(objTablaFiltro["Filtro_Saldo"]);
            objEntidad.FlagAplicarSaldo = Convert.ToInt32(objTablaFiltro["Filtro_FlagAplicarSaldo"]);
        ...
        public void P_ValidarCheck(Hashtable objTablaFiltro, ref DropDownList ddl_combobanco)
        {
            DataTable dta_consulta = null;
        ...
        public void P_VERIFICARNC(Hashtable objTablaFiltro, ref Int32 CodNotaCredito, ref Decimal Saldo, ref String Mensaje, ref Int32 CodMoneda)
        {
            DataTable dta_consulta = null;
            ...
            dta_consulta = objOperacion.F_DocumentoVentaCab_VERIFICARNC(objEntidad);

            if (dta_consulta.Rows.Count > 0)
            {
                CodNotaCredito = Convert.ToInt32(dta_consulta.Rows[0]["CodDocumentoVenta"]);
