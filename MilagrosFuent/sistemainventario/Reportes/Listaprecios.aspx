<%@ Page Title="Inventario Unidades Fisicas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Listaprecios.aspx.cs" Inherits="SistemaInventario.Reportes.Listaprecios" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="Listaprecios.js"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 430px">
        Inventario Unidades Fisicas</div>
    <div id="divConsultaArticulo" style="width: 430px">
            ...
            <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
                ...
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    ...
                    <td colspan='4' style="padding-left: 4px;">
                        <div id="div_excel">
                            <asp:DropDownList ID="ddlExcel" runat="server" Font-Names="Arial" ForeColor="Blue"
