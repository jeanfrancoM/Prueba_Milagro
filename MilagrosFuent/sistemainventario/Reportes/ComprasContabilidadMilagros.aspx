<%@ Page Title="Reporte Compras" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ComprasContabilidadMilagros.aspx.cs" Inherits="SistemaInventario.Reportes.ComprasContabilidadMilagros" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ComprasContabilidadMilagros.js" charset="UTF-8"></script>
