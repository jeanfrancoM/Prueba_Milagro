            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_Marca', result.split('~')[15]);
                        ...
                        $('#MainContent_txtPrecio4').val('0');
                        $('#MainContent_txtPrecio5').val('0');
                        $('#MainContent_txtMargen5').val('0');
                        $('#MainContent_txtMargen4').val('0');
                        $('#MainContent_txtMargen3').val('0');
                        $('#MainContent_txtMargen2').val('0');
...
function F_ValidarGrabarDocumento() {
    ...
    try {
        ...
        var preciomin = $('#MainContent_txtCosto').val() * (1 + ($('#MainContent_txtMargen1').val() / 100));
        ...
        if ($(Cuerpo + 'txtPrecio1').val() < $(Cuerpo + 'txtCosto').val())
            Cadena = Cadena + '<p></p>' + 'El precio 1 no puede ser menor que el Costo';

        if ($(Cuerpo + 'txtPrecio1').val() < Number(preciomin))
            Cadena = Cadena + '<p></p>' + 'El precio 1 no puede ser menor que el Precio Minimo';
        ...
        F_GrabarDocumento_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se Grabo Correctamente.') {
                    ...
                    $(Contenedor + 'ddlFamilia').val('22');
                    $(Contenedor + 'txtPrecio1').val(''),
                    $(Contenedor + 'txtPrecio2').val('0');
                    $(Contenedor + 'txtPrecio3').val('0');
                    $(Contenedor + 'txtPrecio4').val('0');
                    $(Contenedor + 'txtPrecio5').val('0');
                    ...
                    $(Contenedor + 'txtMargen2').val('0');
                    $(Contenedor + 'txtMargen3').val('0');
                    $(Contenedor + 'txtMargen4').val('0');
                    $(Contenedor + 'txtMargen5').val('0');
...
function F_ValidarEdicionDocumento() {
    ...
    try {
        ...
        var preciomin = $('#MainContent_txtCostoEdicion').val() * (1 + ($('#MainContent_txtMargen1Edicion').val() / 100));

        if ($(Cuerpo + 'txtDescripcionEdicion').val() == '')
            Cadena = Cadena + '<p></p>' + 'Descripcion';

        if ($(Cuerpo + 'txtCodigoInternoEdicion').val() == '')
        Cadena = Cadena + '<p></p>' + 'Codigo Unico';
...
//            Cadena = Cadena + '<p></p>' + 'Factor';
        ...
        if (Number($(Cuerpo + 'txtPrecio1Edicion').val()) <Number( $(Cuerpo + 'txtCostoEdicion').val()))
            Cadena = Cadena + '<p></p>' + 'El precio 1 no puede ser menor que el Costo';

        if (Number($(Cuerpo + 'txtPrecio1Edicion').val()) < Number(preciomin))
            Cadena = Cadena + '<p></p>' + 'El precio 1 no puede ser menor que el Precio Minimo';
