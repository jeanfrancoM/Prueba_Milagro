...
{
    public partial class TipoCambio_OLD : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Session["datos"] = true;
            if (!IsPostBack) {
                hpltcs.NavigateUrl = new MaestraCN().ObtenerValor(1001);
                hpltcb.NavigateUrl = new MaestraCN().ObtenerValor(1002);
            }
        }
