...
namespace SistemaInventario.Maestros
{
    public partial class Vendedores : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddlTipoEmpleado_html = "";
            String str_ddlTipoEmpleadoEdicion_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlEstado, ref ddlEstadoEdicion, ref ddlRuta, ref ddlRutaEdicion,
                                       ref ddlTipoEmpleado, ref ddlTipoEmpleadoEdicion);
                ...
                str_ddlTipoEmpleado_html = Mod_Utilitario.F_GetHtmlForControl(ddlTipoEmpleado);
                str_ddlTipoEmpleadoEdicion_html = Mod_Utilitario.F_GetHtmlForControl(ddlTipoEmpleadoEdicion);
            ...
            str_resultado =
                ...
                str_ddlRuta_html
                 + "~" +
                str_ddlRutaEdicion_html
                 + "~" +
                str_ddlTipoEmpleado_html
                 + "~" +
                str_ddlTipoEmpleadoEdicion_html
                 + "~" +
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro,ref DropDownList ddl_comboestado,
                    ref DropDownList ddl_comboestadoedicion, ref DropDownList ddl_comboruta, ref DropDownList ddl_comborutaedicion, 
                    ref DropDownList ddl_combotipoempleado, ref DropDownList ddl_combotipoempleadoedicion)
        {
            ...
            objEntidadConceptosDet.CodConcepto = 2;

            dta_consulta = objOperacionConceptosDet.F_TCConceptos_Select(objEntidadConceptosDet);

            ddl_combotipoempleado.Items.Clear();

            ddl_combotipoempleado.DataSource = dta_consulta;
            ddl_combotipoempleado.DataTextField = "DscAbvConcepto";
            ddl_combotipoempleado.DataValueField = "CodConcepto";
            ddl_combotipoempleado.DataBind();

            ddl_combotipoempleadoedicion.Items.Clear();

            ddl_combotipoempleadoedicion.DataSource = dta_consulta;
            ddl_combotipoempleadoedicion.DataTextField = "DscAbvConcepto";
            ddl_combotipoempleadoedicion.DataValueField = "CodConcepto";
            ddl_combotipoempleadoedicion.DataBind();            
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objEntidad.Vendedor = Convert.ToString(objTablaFiltro["Filtro_Vendedor"]);
            ...
            objEntidad.nvClave = Convert.ToString(objTablaFiltro["Filtro_Clave"]);
            objEntidad.nvNombreUsuario = Convert.ToString(objTablaFiltro["Filtro_Usuario"]);
            objEntidad.CodTipoEmpleado = Convert.ToInt32(objTablaFiltro["Filtro_CodTipoEmpleado"]);
            objEntidad.FlagAdministrador = Convert.ToInt32(objTablaFiltro["Filtro_FlagAdministrador"]);
            objEntidad.FlagCredito = Convert.ToInt32(objTablaFiltro["Filtro_FlagAprobacionCredito"]);
            objEntidad.FlagUsuario = Convert.ToInt32(objTablaFiltro["Filtro_FlagUsuario"]);
            objOperacion = new TCCuentaCorrienteCN();

            objOperacion.F_VendedoresExternos_Insert(objEntidad);
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            objEntidad.Vendedor = Convert.ToString(objTablaFiltro["Filtro_Descripcion"]);

            objOperacion = new TCCuentaCorrienteCN();

            dta_consulta = objOperacion.F_Vendedor_Listar(objEntidad);
        ...
        public void P_EditarRegistro(Hashtable objTablaFiltro, ref String MsgError)
        {
            ...
            objOperacion.F_VendedoresExternos_Update(objEntidad);
