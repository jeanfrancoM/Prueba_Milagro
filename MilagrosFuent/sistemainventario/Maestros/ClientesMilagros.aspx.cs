...
namespace SistemaInventario.Maestros
{
    public partial class ClientesMilagros : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            String str_ddlRutaConsulta_html = "";
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlTipoCliente, ref ddlTipoCliente_Edicion, ref ddlRuta, ref ddlRutaEdicion, ref ddlRutaConsulta,
                ...
                str_ddlRutaConsulta_html = Mod_Utilitario.F_GetHtmlForControl(ddlRutaConsulta);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro,ref DropDownList ddl_combofamilia,ref DropDownList ddl_combofamiliaedicion,
                    ref DropDownList ddl_comboruta, ref DropDownList ddl_comborutaedicion, ref DropDownList ddl_comborutaConsulta, ref DropDownList ddl_comboformapago,
                    ...
                    ref DropDownList ddl_comboletra, ref DropDownList ddl_comboletraedicion, ref DropDownList ddl_flagigv, ref DropDownList ddl_flagigvEdicion)                    
        {
            ...
            ddl_comborutaConsulta.Items.Clear();

            ddl_comborutaConsulta.DataSource = dta_consulta;
            ddl_comborutaConsulta.DataTextField = "DscAbvConcepto";
            ddl_comborutaConsulta.DataValueField = "CodConcepto";
            ddl_comborutaConsulta.DataBind();
            ddl_comborutaConsulta.Items.Add(new ListItem() { Value = "0", Text = "TODOS" });
        ...
        public void P_Buscar(Hashtable objTablaFiltro, ref GridView GrillaBuscar)
        {
            ...
            objEntidad.CodRuta = Convert.ToInt32(objTablaFiltro["Filtro_Ruta"]);
            objEntidad.CodTipoCtacte =1;
