                    ...
                    <table cellpadding="0" cellspacing="0" class="form-inputs">
                        ...
                        <tr>
                         ...
                         <tr  style = "display:none">
                            ...
                            <td style="padding-left: 4px;" colspan='5'>
                                <asp:TextBox ID="TextBox1" runat="server" Width="500px" Font-Names="Arial" Height="36"
                                    Font-Bold="True" ForeColor="Blue"></asp:TextBox>
                            </td>
                        </tr>
                ...
                <div class="ui-jqdialog-content">
                    <table cellpadding="0" cellspacing="0" class="form-inputs" width="700">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDescripcionConsulta" runat="server" Width="572" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                            </td>
                            <td style="font-weight: bold">
                               Rutas
                            ...
                            <td style="padding-left: 4px;" colspan='5'>
                            <div id="div_RutaConsulta">
                                <asp:DropDownList ID="ddlRutaConsulta" runat="server" Font-Names="Arial" ForeColor="Blue"
                                    Font-Bold="True" BackColor="#FFFF99" Width="150">
                                </asp:DropDownList>
                            </div>
                        </td>
                    ...
                    <Columns>
                       ...
                       <asp:TemplateField HeaderText="RUC" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfRetencion" runat="server" Value='<%# Bind("FlagRetencion") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                    ...
                    <div id="div_Direccion">
                        <asp:GridView ID="grvDireccion" runat="server" AutoGenerateColumns="False" border="0"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Email 2" HeaderStyle-HorizontalAlign="Left" Visible="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblEmail2" Text='<%# Bind("Email2") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Email 3" HeaderStyle-HorizontalAlign="Left" Visible="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblEmail3" Text='<%# Bind("Email3") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Email 4" HeaderStyle-HorizontalAlign="Left" Visible="false">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
