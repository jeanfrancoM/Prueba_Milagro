...
$(document).ready(function () {
    ...
    $('#MainContent_ddlRutaConsulta').css('background', '#FFFFE0');
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_RutaConsulta', result.split('~')[14]);
                        ...
                        $('#MainContent_ddlRutaConsulta').css('background', '#FFFFE0');
                        $('#MainContent_ddlRutaConsulta').val(0);
                        $('#MainContent_ddlFormaPago').val(1);
                        $('#MainContent_ddlTipoImpuesto').val(1);
...
//            Cadena = Cadena + '<p></p>' + "Letra";
        ...
        if ($(Cuerpo + 'ddlFormaPago').val() === null)
            Cadena = Cadena + '<p></p>' + "FormaPago";
...
function F_Buscar() {
    ...
    try {
        var objParams = {
            ...
            Filtro_Ruta: $("#MainContent_ddlRutaConsulta").val()
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var hfRetencion = '#' + imgID.replace('imgEditarRegistro', 'hfRetencion');
        ...
        $(Cuerpo + 'chkRetencion').prop('checked', $(hfRetencion).val() === '1');
...
function F_EdicionRegistro() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_FlagRetencion: $(Contenedor + 'chkRetencion').is(':checked') ? 1 : 0,
