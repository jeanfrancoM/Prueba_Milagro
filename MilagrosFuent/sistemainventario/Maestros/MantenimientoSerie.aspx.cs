    ...
    public partial class MantenimientoSerie : System.Web.UI.Page
    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlSerie, ref ddlDocumento,ref ddlEmpresa);
                P_Obtener_TipoCambio(obj_parametros, ref TC);
                str_ddlEmpresa = Mod_Utilitario.F_GetHtmlForControl(ddlEmpresa);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro, ref DropDownList ddl_comboserie,ref DropDownList ddl_combodocumento, ref DropDownList ddl_comboempresa)                                           
        {
