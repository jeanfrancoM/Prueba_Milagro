<%@ Page Title="Factura Compra" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"    CodeBehind="RegistroFacturaCompra.aspx.cs" Inherits="SistemaInventario.Compras.RegistroFacturaCompra" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaCompra.js"  charset="UTF-8"></script>      
                            ...
                            <tr>
                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtProveedor" runat="server" Width="475px" Font-Names="Arial" ForeColor="Blue"
                            ...
                            <tr>
                                ...
                                <td>
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <asp:TextBox ID="txtNumeroGuia" runat="server" Width="475" Font-Names="Arial" ForeColor="Blue"
                                                    Font-Bold="True"></asp:TextBox>
                                            </td>
                                            <td style="font-weight: bold">
                                                ALMACEN
                                    ...
                                    <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                                        <asp:GridView ID="grvDetalle" runat="server" border="0" CellPadding="0" CellSpacing="1"
                                            ...
                                            <Columns>
                                                ...
                                                <%--  <asp:BoundField DataField="PrecioSD" HeaderText="Precio S/D">
                                                    <HeaderStyle HorizontalAlign="Center" />
                                                    <ItemStyle HorizontalAlign="Right" />
                                                </asp:BoundField>--%>
