                                                ...
                                                <tr>
                                                    <td>
                                                        <div id="div_serieguia">
                                                            <asp:DropDownList ID="ddlSerieGuia" class="selDiv" runat="server" Font-Names="Arial"
                        ...
                        <asp:TemplateField HeaderText="Descripcion" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox runat="server" ID="txtDescripcion" Font-Bold="true" CssClass="ccsestilo"
                                    Width="480px" Font-Names="Arial" ForeColor="Blue" Text='<%# Bind("Producto") %>'></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center"></ItemStyle>
                        </asp:TemplateField>
            ...
            <div id="div_consulta" style="padding-top: 5px;">
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="BO" Visible="false">
                            <ItemTemplate>
