<%@ Page Title="Historial Compra Sunat" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="HistorialCompraSunat.aspx.cs" Inherits="SistemaInventario.Reportes.HistorialCompraSunat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="HistorialCompraSunat.js"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 300px">
        Reporte de Historial Compras Sunat</div>
