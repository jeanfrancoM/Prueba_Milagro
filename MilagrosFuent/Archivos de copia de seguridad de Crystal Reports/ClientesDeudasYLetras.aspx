<%@ Page Title="Reporte Historial Cobranzas" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="ClientesDeudasYLetras.aspx.cs" Inherits="SistemaInventario.Reportes.ClientesDeudasYLetras" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ClientesDeudasYLetras.js"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="titulo" style="width: 500px">
        Reporte de Clientes Con Deudas y Pagan Con Letras</div>
    <div id='divConsulta' class="ui-jqgrid ui-widget ui-widget-content ui-corner-all"
        style="width: 500px">
        <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix">
            Criterio de busqueda
        </div>
        <div class="ui-jqdialog-content" style="width: 700px; display:none" >
                    ...
                    <td colspan='4'>
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="display:none" >
                                    <asp:CheckBox ID="chkDetallado" runat="server" Text="Detallado" Font-Bold="True" Checked="true"  />
                                </td>
                            </tr>
                        </table>
                    </td>
