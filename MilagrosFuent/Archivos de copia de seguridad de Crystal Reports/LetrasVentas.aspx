<%@ Page Title="Letras - Ventas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="LetrasVentas.aspx.cs" Inherits="SistemaInventario.CuentasPorCobrar.LetrasVentas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="divSeleccionarEmpresa">
        <table>
            ...
            <tr align="right">
                <td>
                    <asp:Button ID="btnValidar2" runat="server" Text="Aceptar" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only"
                        Font-Names="Arial" Font-Bold="True" Width="120px" />
                </td>
            </tr>
        </table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtUsuarioEliminacion" runat="server" Width="98px" Font-Names="Arial"
                        ForeColor="Blue" Font-Bold="True" ToolTip="Ingresar Usuario" autocomplete="new-password"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td style="font-weight: bold">
                ...
                <td>
                    <asp:TextBox ID="txtClaveEliminacion" runat="server" Width="98px" Font-Names="Arial"
                        ForeColor="Blue" Font-Bold="True" TextMode="Password" ToolTip="Ingresar Clave"
    ...
    <input id="hfCodMoneda" type="hidden" value="0" />
</asp:Content>
