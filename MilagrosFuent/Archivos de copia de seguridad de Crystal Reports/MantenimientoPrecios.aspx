<%@ Page Title="Lista Precios" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MantenimientoPrecios.aspx.cs" Inherits="SistemaInventario.Maestros.MantenimientoPrecios" %>
    ...
    <div>
     ...
     <div id="tabRegistro">
            <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all" style="width: 400px">
                <div class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix" style="width: 399px">
