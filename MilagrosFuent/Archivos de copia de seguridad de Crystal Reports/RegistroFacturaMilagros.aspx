<%@ Page Title="Factura" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroFacturaMilagros.aspx.cs" Inherits="SistemaInventario.Ventas.RegistroFacturaMilagros" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="RegistroFacturaMilagros.js"
                    ...
                    <asp:TemplateField HeaderText="Desc" ItemStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:TextBox runat="server" ID="txtDescuento1" Width="35px" Font-Bold="true" Style="text-align: center;"
                                ...
                                Text='<%# Bind("Descuento1") %>' CssClass="ccsestilo" Enabled="true" ReadOnly="false"></asp:TextBox>
                        </ItemTemplate>
                    </asp:TemplateField>
