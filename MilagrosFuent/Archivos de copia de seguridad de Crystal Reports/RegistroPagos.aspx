<%@ Page Title="Pagos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="RegistroPagos.aspx.cs" Inherits="SistemaInventario.CuentasPorPagar.RegistroPagos" %>
                ...
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Nro Operacion">
                            <ItemStyle HorizontalAlign="Left" />
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblNroOperacion" Text='<%# Bind("NroOperacion") %> ' CssClass="detallesart"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="padding-left: 16px;" colspan='3'>
                                    <asp:TextBox ID="txtNroOperacionEdicion" runat="server" Width="350px" Font-Names="Arial"
                                        ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="padding-left: 16px;" colspan='3'>
                                    <asp:TextBox ID="txtObservacion" runat="server" Width="350px" Height="120px" TextMode="MultiLine"
                                        Font-Names="Arial" ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
